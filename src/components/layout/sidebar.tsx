...
//   const currentLogo = mounted && resolvedTheme === "dark" ? logoSrcDark : logoSrc;
...
//           <Image src={currentLogo} alt="Hospital Logo" fill className="object-contain object-left" priority />
//         </div>
//         <button
...
//               <Image src={currentLogo} alt="Hospital Logo" fill className="object-contain object-center" priority />
//             </div>
//           )}
