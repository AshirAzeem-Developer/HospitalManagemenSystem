...
export default function SettingsPanel({ children }: SettingsPanelProps) {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col lg:flex-row rounded-xl border border-[#E5E7EB] dark:border-[#2A3850] bg-white dark:bg-[#152035] overflow-hidden">
        <aside className="w-full lg:w-[220px] shrink-0 border-b lg:border-b-0 lg:border-r border-[#E5E7EB] dark:border-[#2A3850] p-4">
        ...
        <div className="flex-1 p-4 lg:p-6 min-w-0 dark:bg-[#152035]">{children}</div>
      </div>
    </div>
  );
}