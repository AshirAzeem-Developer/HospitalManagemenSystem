      ...
      <div className="rounded-xl border border-[#E7E8EB] bg-white p-4 sm:p-5 lg:p-6">
        <div className="flex justify-end">
          <div className="w-full max-w-[420px] space-y-4">
            ...
            {/* Tax */}
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3 pl-[16px]">
            ...
            {/* Discount */}
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3 pr-[5px]">
